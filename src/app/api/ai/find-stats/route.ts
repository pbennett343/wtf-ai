...
3. ODDSSHARK IS BLOCKED: OddsShark uses bot protection, so you MUST search Covers, Action Network, TeamRankings, or VSiN instead.
4. NO BETTING LINES: You MUST ONLY return historical trends/streaks (e.g., "14-2 in their last 16 games"). You are strictly BANNED from returning betting lines, odds, or moneylines (e.g., "Dodgers are -150 to win" or "The line is set at 8.5"). If it is not a historical streak, REJECT IT.
5. ONLY MLB: Do NOT include NBA, NFL, NHL, or any other sport.
6. ACTIVE GAMES ONLY: REJECT any team that is not playing in the next 48 hours.
7. EXACT DATES ONLY: The date field MUST be the exact date of the game (e.g. "${TODAY}"). NEVER say "Today" or "Tonight".
8. MANDATORY CATEGORY QUOTA (8 slots, in this order):
